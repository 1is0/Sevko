...
// Inf prints information about the version and author of the program
void Inf(void)
{
	printf("Author: Sevko Polina Romanovna, gr. 953502.\nVersion: 1.0\n");
}
// VolCone counts the volume of the cone.
...
void SideSq(int rad)
{
	double side = 0;
	side = rad * pow(2, 0.5);
	printf("Side of the square is %f\n", side);
}
